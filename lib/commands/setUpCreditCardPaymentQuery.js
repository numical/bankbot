'use strict';
// note - almost identical to welcome
...
const welcomeFirstTimeUser = state => {
  ...
  return `Should I notify you when your credit card repayment is due?`;
};
